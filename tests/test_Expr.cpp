...
ANON_TEST_CASE() {
  State state = {{"x0", 20}, {"x1", 382}, {"x2", 143}, {"x3", 4}, {"x4", 709}};
...
ANON_TEST_CASE() {
  State state = {{"x0", 991}, {"x1", 50}, {"x2", 719}, {"x3", 911}, {"x4", 24}};
...
ANON_TEST_CASE() {
  State state = {{"x0", 439}, {"x1", 542}, {"x2", 740}, {"x3", 67}, {"x4", 3}};
  auto expr =
...
ANON_TEST_CASE() {
  State state = {{"x0", 259}, {"x1", 264}, {"x2", 997}, {"x3", 905}, {"x4", 0}};
  auto expr =
